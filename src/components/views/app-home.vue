<template>
  <h1 class="normal-case text-amber-400">sentenCy</h1>
  <section class="card">
    <p>
      This is a simple
  ...
  <section>
    <h2>
      <i class="fa fa-question-circle mr-2 text-dark-60"></i> Keep in mind
    </h2>
    <p>
      All the data you are working on is saved in your browser's
